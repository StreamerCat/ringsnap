...
- [ ] **Set `VAPI_TOOL_SECRET` Supabase secret** (Codex review P1 fix) —
      ...
      `supabase secrets set VAPI_TOOL_SECRET=<value>` — don't share the
...
- Server **secret** set to the value of the `VAPI_TOOL_SECRET` Supabase
