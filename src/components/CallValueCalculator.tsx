...
const tradePresets = {
  plumbing: {
    ...
    insight: "Burst pipe callers hire the first responder who picks up. Most don't leave voicemails."
  },
  hvac: {
    label: "HVAC",
    defaults: {
        ...
        <header className="space-y-6">
          ...
          <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(240px,0.8fr)] lg:items-start">
            <div className="space-y-4">
              ...
              <p className="text-body-default text-muted-foreground">Most callers don't leave voicemails. They call the next company.
                Drop in your call volume to see how much revenue RingSnap recovers.</p>
            </div>
            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
              <div className="flex items-center gap-2 text-sm font-semibold text-slate-900">
                <ShieldCheck className="h-4 w-4 text-primary" />
                Based on contractor call patterns
              </div>
