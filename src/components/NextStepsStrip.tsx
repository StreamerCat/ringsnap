    ...
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-5xl mx-auto flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <h3 className="text-xl sm:text-2xl font-semibold text-charcoal mt-2">Follow the 3-step path contractors use to switch .</h3>
        </div>
        <div className="grid gap-4 sm:grid-cols-3 w-full sm:w-auto">
          {steps.map(step => <a key={step.title} href={step.anchor} className="group rounded-2xl border border-primary/20 bg-white/80 p-4 text-left shadow-sm transition hover:border-primary hover:shadow-md">
