            ...
            <div className="space-y-5">
              {comparisons.map(({ href, title, subtitle, desc, tags }) => (
                <Link
                  key={href}
                  to={href}
                  className="group flex flex-col sm:flex-row sm:items-start gap-4 p-6 rounded-2xl border border-transparent bg-card shadow-sm hover:shadow-md hover:border-primary/30 transition-all"
                >
          ...
          <div className="site-container max-w-3xl">
            ...
            <div className="grid sm:grid-cols-2 gap-3">
              {[
                ...
                <div key={item} className="flex items-start gap-3 p-4 rounded-2xl bg-card shadow-sm">
